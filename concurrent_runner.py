...
def command_writer_thread(
    ...
    list_of_movements = ['y 0.2', 'x -0.1', 'z -0.1', 'x 0.1', 'y -0.1', 'x 0.1', 'x -0.1 y 0.1 z 0.1', 'x -0.1 y -0.1', 'y -0.1 z -0.1', 'y 0.2', 'x 0.1', 'y -0.1', 'x 0.1 y 0.1', 'x -0.1 y -0.1', 'x -0.1', 'y 0.1', 'x 0.2', 'x -0.1', 'y -0.1', 'y -0.1 z 0.1']
    ######   ######
